...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route('audio.store') }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">		
				@csrf
				<div class="video-form-container">
					<div class="video-form-body">
						...
						<div class="form-group">
							...
							<input type="text" id="title" autocomplete="off" class="form-control" name="title" value="{{ old('title') }}" placeholder="Enter audio title">
						</div>

						<div class="form-group">
							<label for="file">Audio File <span class="required">*</span></label>
							<input type="file" id="file" autocomplete="off" class="form-control" name="file" value="{{ old('file') }}" required placeholder="Select audio file">
							@error('file')
