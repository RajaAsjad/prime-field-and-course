...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route('brands.update', $model->slug) }}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				{{ method_field('PATCH') }}
					...
					<div class="box-body">
                        <div class="form-group">
                            ...
                            @if(!empty($model->image))
                                <div class="col-sm-4">
                                    <img style="width: 80px" src="{{ asset('public/admin/assets/images/brands') }}/{{ $model->image }}" alt="">
                                </div>
                            @else
                                <div class="col-sm-4" >
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" autocomplete="off" class="form-control" name="url" value="{{$model->url}}">
							</div>
						</div>
						
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Brand Email<span style="color:red">*</span></label>
							<div class="col-sm-8">
								<input type="text" autocomplete="off" class="form-control" name="email" value="{{$model->email}}">
							</div>
						</div>
						<!-- <div class="form-group">
