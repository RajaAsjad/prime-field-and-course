		...
		<div class="col-md-12">
			<form action="{{ route('page_setting.store') }}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="box box-info">
					<div class="box-body">
                        <h3 class="sec_title">Wedding Packages</h3>
                        <div class="form-group">
							<label for="" class="col-sm-2 control-label">Heading</label>
							<div class="col-sm-9">
								<input type="text" name="wedding_heading" class="form-control" value="{{ isset($page_data['wedding_heading'])?$page_data['wedding_heading']:'' }}" placeholder="Enter heading">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Description</label>
							<div class="col-sm-9">
								<textarea name="wedding_description" class="form-control texteditor" cols="30" rows="10" placeholder="Enter description">{!! isset($page_data['wedding_description'])?$page_data['wedding_description']:'' !!}</textarea>
							</div>
						</div>
						<div class="form-group">
