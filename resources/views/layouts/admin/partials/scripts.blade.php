...
<!-- scrollbar js-->
<script src="/assets/admin/js/scrollbar/simplebar.min.js"></script>
...
<script src="/assets/admin/js/datatable/datatables/dataTables.js"></script>
<script src="/assets/admin/js/datatable/datatables/dataTables.select.js"></script>
<script src="/assets/admin/js/datatable/datatables/select.bootstrap5.js"></script>
