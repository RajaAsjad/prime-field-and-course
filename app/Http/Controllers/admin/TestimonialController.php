...
class TestimonialController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $inactiveTestimonials = Testimonial::where('status', 0)->count();
        $testimonials = Testimonial::orderby('id', 'desc')->paginate(10);
        return view('admin.testimonial.index', compact('testimonials', 'page_title', 'totalTestimonials', 'activeTestimonials', 'inactiveTestimonials'));
    }
