...
class PageSettingController extends Controller
{
    ...
    {
        $skipKeys = ['_token', 'parent_slug', 'form_about'];
    ...
    public function show($slug)
    {
        ...
        foreach ($page_settings as $key => $page_setting) {
            ...
            $page_data[$page_setting->key] = $val;
        }
        ...
        if($slug=='home'){
            ...
            $page_title = 'Home About';
            return view('admin.page_setting.home_about', compact("model", "page_data", "page_title"));
