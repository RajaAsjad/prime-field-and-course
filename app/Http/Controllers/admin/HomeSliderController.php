...
class HomeSliderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $totalSliders = HomeSlider::count();
        $activeSliders = HomeSlider::where('status', 1)->count();
        $inactiveSliders = HomeSlider::where('status', 0)->count();
        $homesliders = HomeSlider::orderby('id', 'desc')->paginate(10);
        return view('admin.home_slider.index', compact('homesliders', 'page_title', 'totalSliders', 'activeSliders', 'inactiveSliders'));
    }
