            ...
            _createClass(Iti, [ {
                ...
                value: function _bindDropdownListeners() {
                    ...
                    this._handleKeydownOnDropdown = function(e) {
                        ...
                        if (e.key === "ArrowUp" || e.key === "Up" || e.key === "ArrowDown" || e.key === "Down") _this9._handleUpDownKey(e.key); else if (e.key === "Enter") _this9._handleEnterKey(); else if (e.key === "Escape") _this9._closeDropdown(); else if (/^[a-zA-ZÃƒÆ’Ã¢â€šÂ¬-ÃƒÆ’Ã‚Â¿ÃƒÂÃ‚Â°-Ãƒâ€˜Ã‚ÂÃƒÂÃ‚Â-ÃƒÂÃ‚Â¯ ]$/.test(e.key)) {
